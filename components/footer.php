  ...
  <div class="footer-inner">
    <div class="footer-top">
      ...
      <div class="footer-brand">
        ...
        <p>Plataforma académica oficial del programa de Ingeniería en Telecomunicaciones en la universidad CUCSur.
          Formando profesionales para la próxima era digital.</p>
      </div>

      <div class="footer-col">
        <h4>Institución</h4>
        <ul>
          <li>Centro Universitario de la Costa Sur</li>
          <li>Av. Independencia Nacional No.151, Colonia Centro, C.P. 48900,</li>
          <li>Autlán de Navarro, Jalisco, México</li>
          <li>+52 (317) 3825010</li>
        </ul>
      </div>
