<footer class="m-0 bg-[var(--color-navy)] text-white pt-10 pb-6 px-5 sm:px-8 md:pt-12 border-t border-gray-700">
  <div class="max-w-6xl mx-auto">
    <div class="grid grid-cols-2 gap-x-6 gap-y-8 mb-8 md:grid-cols-4 md:gap-8 md:mb-10">
      ...
      <!-- Institución -->
      <div class="col-span-2 order-3 flex flex-col pt-6 border-t border-white/10 md:col-span-1 md:order-none md:pt-0 md:border-t-0">
        <h4 class="text-xs font-bold uppercase text-[var(--color-green-lt)] mb-3 md:mb-4">Institución</h4>
        <ul class="flex flex-col gap-1.5 md:gap-2 m-0 p-0 list-none">
          <li class="text-[.82rem] md:text-sm text-gray-400">Centro Universitario de la Costa Sur</li>
          <li class="text-[.82rem] md:text-sm text-gray-400">Av. Independencia Nacional No.151, Colonia Centro, C.P. 48900,</li>
          <li class="text-[.82rem] md:text-sm text-gray-400">Autlán de Navarro, Jalisco, México</li>
          <li class="text-[.82rem] md:text-sm text-gray-400">+52 (317) 3825010</li>
        </ul>
      </div>
    ...
    <hr class="border-gray-700 mb-5 md:mb-6">

    <!-- Barra inferior: en celular, redes arriba y copyright centrado debajo -->
    <div class="flex flex-col-reverse items-center gap-4 text-center md:flex-row md:flex-wrap md:justify-between md:text-left">
      <div class="text-xs leading-relaxed text-gray-400 text-balance">
